  ...
  return(
    <div className="app">
      ...
      <aside className={`sidebar${sidebarOpen?' open':''}`}>
        <div className="sidebar-brand"><div style={{display:'flex',alignItems:'center',gap:12}}><img src="data:image/png;base64," alt="CA" style={{width:36,height:36,borderRadius:8,background:'#F7F5F2',objectFit:'contain',padding:3}}/><div><h1 style={{fontFamily:'Instrument Serif,Georgia,serif',fontSize:20,fontWeight:400,color:'#fff',lineHeight:1}}>CA Homes</h1><p style={{fontSize:10,color:'rgba(255,255,255,0.4)',letterSpacing:1,textTransform:'uppercase',marginTop:2}}>Property Management</p></div></div></div>
